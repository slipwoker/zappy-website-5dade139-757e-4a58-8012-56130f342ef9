    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "גרמי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '5dade139-757e-4a58-8012-56130f342ef9',
                    name: data.name || '',
                    email: data.email || '',
